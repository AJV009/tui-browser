...
const TerminalView = (() => {
  ...
  function renderTuiActions(actions, serverName) {
    ...
    for (const action of actions) {
      ...
      const icon = action.icon && TUI_ICONS[action.icon];
      if (icon) {
        btn.innerHTML = icon;
      } else {
